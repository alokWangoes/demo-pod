...
import MyProfileIcon from "../../public/automation-icons/my-profile-Icon.svg"
...
type AutomationPageProps = {
  openValSelector: boolean
  openOrderSelector: boolean
  openNotificationBox: boolean
  openProfileOption: boolean
  openActionDropdown: number
  ...
  profileAction: {
    id: number
    icon: React.ReactElement<SVGAElement> | string
    class: string
    text: string
    textClass: string
  }[]
  ...
  automationContentBoxData: {
    ...
    text: string
    statusText: string
    statusIcon: React.ReactElement<SVGAElement>
    statusClass: string
    dataNeeded: {
      show: boolean
      class: string
...
const actionDropdownData: AutomationPageProps["actionDropdown"] = [
  {
    id: 1,
    icon: <EditIcon />,
    text: "Edit",
...
const profileOptionData: AutomationPageProps["profileAction"] = [
  {
    id: 1,
    icon: <MyProfileIcon />,
...
const orderField: AutomationPageProps["orderField"] = [
  {
    id: 1,
...
const rangeValue: AutomationPageProps["rangeValue"] = [
  {
    id: 1,
    value: 5,
  },
...
const automationContentBoxData: AutomationPageProps["automationContentBoxData"] =
  [
    {
      id: 1,
      title: "Lorem Ipsum",
      ...
      statusClass: "workflow-content-status status-active",
      dataNeeded: {
        show: false,
        class: "",
        text: "",
...
const AutomationPage = () => {
  const [openValSelector, setOpenValSelector] =
    useState<AutomationPageProps["openValSelector"]>(false)
  const [openOrderSelector, setOpenOrderSelector] =
    useState<AutomationPageProps["openOrderSelector"]>(false)
  const [openNotificationBox, setOpenNotificationBox] =
    useState<AutomationPageProps["openNotificationBox"]>(false)
  const [openProfileOption, setOpenProfileOption] =
    useState<AutomationPageProps["openProfileOption"]>(false)
  const [openActionDropdown, setOpenActionDropdown] =
    useState<AutomationPageProps["openActionDropdown"]>(0)
